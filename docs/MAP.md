...
| Today & planning | `services/today.ts`, `services/planToday.ts`, `services/adaptivePlanning.ts` | [06](capabilities/06-today-and-planning.md) | `packages/core/test/adaptivePlanning.test.ts` |
